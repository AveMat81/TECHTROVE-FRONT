...
const Searchbar = ({ onFocusChange, onClose, handlerSearch2, showCategories }) => {
  ...
  return (
    ...
    >
      <div className="w-18 mt-2 p-4 pb-2 flex items-center justify-end">
        <input
          type="text"
          className={"z-300 p-[8px] rounded-full border border-gray-500 flex-1 text-gray-500"}
